...
@Entity
@Table(name = "TB_OS_ENCRYPTN")
public class TbOsEncryptionEntity implements Serializable {
	...
	@Id
	@GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "SEQ_OS_ENCRYPTION_GEN")
	@SequenceGenerator(name ="SEQ_OS_ENCRYPTION_GEN", sequenceName = "SEQ_OS_ENCRYPTION", allocationSize = 1)
	private Long id;
	...
	@Column(name = "KEK_JKS_PATH")
	private String kekJksPath;
	
	@Column(name = "KEK_JKS_PSWD")
	private String kekJksPswd;
	
	@Column(name = "CUSTODIAN_1_KEY")
	private String custodian1Key;
	
	@Column(name = "CUSTODIAN_1_SALT")
	private String custodian1Salt;
	
	@Column(name = "CUSTODIAN_2_KEY")
	private String custodian2Key;
	
	@Column(name = "CUSTODIAN_2_SALT")
	...
	public boolean equals(Object obj) {
		...
		TbOsEncryptionEntity refObj = (TbOsEncryptionEntity) obj;
		EqualsBuilder eb = new EqualsBuilder();
		eb.append(id, refObj.getId());
		return eb.isEquals();
	}
