...
public class JwtRequestFilter extends OncePerRequestFilter {
	...
	protected void doFilterInternal(HttpServletRequest request, HttpServletResponse response, FilterChain filterChain)
		...
		response.setHeader("Access-Control-Request-Headers","authtoken,Content-Type, Content-Length, X-Requested-With,userId,bankKey,bankId,systemId,cmpnyNm,cmpnyId,sessionUniqueId,SELECTED_APP");
		response.setHeader("Access-Control-Allow-Headers","authtoken,Content-Type, Content-Length, X-Requested-With,userId,bankKey,bankId,systemId,cmpnyNm,cmpnyId,sessionUniqueId,SELECTED_APP");
